...
import type { Job as _Job, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async listMyJobs(): Promise<Array<Job>> {
        if (this.processError) {
            try {
    ...
    async processJob(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async submitJob(arg0: string, arg1: string, arg2: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitJob(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Job_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Job): Job {
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Job]): Job | null {
    return value.length === 0 ? null : from_candid_Job_n14(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        errorMessage: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.errorMessage)),
        enhancementType: value.enhancementType,
        scale: value.scale,
        updatedAt: value.updatedAt,
        resultBlobId: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.resultBlobId)),
        originalBlobId: value.originalBlobId
    };
}
...
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Job>): Array<Job> {
    return value.map((x)=>from_candid_Job_n14(_uploadFile, _downloadFile, x));
}
