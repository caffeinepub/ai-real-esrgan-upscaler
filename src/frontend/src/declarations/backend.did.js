...
export const Job = IDL.Record({
  ...
  'enhancementType' : IDL.Text,
  'scale' : IDL.Nat,
  'updatedAt' : IDL.Int,
  'resultBlobId' : IDL.Opt(IDL.Text),
  'originalBlobId' : IDL.Text,
});
...
export const idlService = IDL.Service({
  ...
  'listMyJobs' : IDL.Func([], [IDL.Vec(Job)], ['query']),
  'processJob' : IDL.Func([IDL.Text], [IDL.Bool], []),
  'saveCallerUserProfile' : IDL.Func([UserProfile], [], []),
  'submitJob' : IDL.Func([IDL.Text, IDL.Text, IDL.Nat], [IDL.Text], []),
  'transform' : IDL.Func(
      [TransformationInput],
